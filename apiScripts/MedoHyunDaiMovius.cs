...
public class MedoHyunDaiMovius : MonoBehaviour
{
    ...
    void TaskOnClick()
    {
        ...
        if (selector != null)
        {
            ...
            if (gameManager != null)
            {
                ...
                {
                    string HDMVariable = "HyunDaiMovius";
                    gameManagerScript.MedoHDMPNL(HDMVariable, indicatorText, indicator1Text, gameManagerScript.HDMweekValue);
                }
                else
                {
