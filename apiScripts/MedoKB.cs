...
public class MedoKB : MonoBehaviour
{
    ...
    void TaskOnClick()
    {
        ...
        if (selector != null)
        {
            ...
            if (gameManager != null)
            {
                ...
                {
                    string KBVariable = "KB";
                    gameManagerScript.MedoKBPNL(KBVariable, indicatorText, indicator1Text, gameManagerScript.KBweekValue);
                }
                else
                {
