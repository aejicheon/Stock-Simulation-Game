...
public class MedoSeltrion : MonoBehaviour
{
    ...
    void TaskOnClick()
    {
        ...
        if (selector != null)
        {
            ...
            if (gameManager != null)
            {
                ...
                {
                    string SeltrionVariable = "Seltrion";
                    gameManagerScript.MedoSTPNL(SeltrionVariable, indicatorText, indicator1Text, gameManagerScript.STweekValue);
                }
                else
                {
