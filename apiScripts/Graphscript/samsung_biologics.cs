...
using YourNamespace5;

public class samsung_biologics : MonoBehaviour
{
    private string url = "https://racconworld.com:8081/historical-stock-prices/207940.KS";
    ...
    {
        int minY = 950000; // 최소 종가
        int maxY = 670000; // 최대 종가
