...
using YourNamespace8;

public class ls_chemical : MonoBehaviour
{
    private string url = "https://racconworld.com:8081/historical-stock-prices/051910.KS";
    ...
    {
        int minY = 840000; // 최소 종가
        int maxY = 410000; // 최대 종가
