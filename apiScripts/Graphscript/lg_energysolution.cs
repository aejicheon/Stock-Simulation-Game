...
public class lg_energysolution : MonoBehaviour
{
    private string url = "https://racconworld.com:8081/historical-stock-prices/373220.KS";
    ...
    {
        int minY = 350000; // 최소 종가
        int maxY = 700000; // 최대 종가
