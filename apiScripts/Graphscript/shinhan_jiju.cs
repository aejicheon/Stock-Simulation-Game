...
using YourNamespace18;

public class shinhan_jiju : MonoBehaviour
{
    private string url = "https://racconworld.com:8081/historical-stock-prices/055550.KS";
    ...
    {
        int minY = 45000; // 최소 종가
        int maxY = 30000; // 최대 종가
