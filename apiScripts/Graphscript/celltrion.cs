...
using YourNamespace15;

public class celltrion : MonoBehaviour
{
    private string url = "https://racconworld.com:8081/historical-stock-prices/068270.KS";
    ...
    {
        int minY = 180000; // 최소 종가
        int maxY = 130000; // 최대 종가
