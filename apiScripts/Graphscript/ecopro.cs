...
public class ecopro : MonoBehaviour
{
    private string url = "https://racconworld.com:8081/historical-stock-prices/086520.KQ";
    ...
    {
        int minY = 100000; // 최소 종가
        int maxY = 1300000; // 최대 종가
