...
using YourNamespace12;

public class posco_futurem : MonoBehaviour
{
    private string url = "https://racconworld.com:8081/historical-stock-prices/035420.KS";
    ...
    {
        int minY = 240000; // 최소 종가
        int maxY = 170000; // 최대 종가
