...
using YourNamespace10;

public class kia : MonoBehaviour
{
    private string url = "https://racconworld.com:8081/historical-stock-prices/000270.KS";
    ...
    {
        int minY = 91000; // 최소 종가
        int maxY = 57000; // 최대 종가
