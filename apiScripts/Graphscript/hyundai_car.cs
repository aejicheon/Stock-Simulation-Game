...
using YourNamespace7;

public class hyundai_car : MonoBehaviour
{
    private string url = "https://racconworld.com:8081/historical-stock-prices/005380.KS";
    ...
    {
        int minY = 215000; // 최소 종가
        int maxY = 145000; // 최대 종가
