...
using YourNamespace16;

public class samsung_corporation : MonoBehaviour
{
    private string url = "https://racconworld.com:8081/historical-stock-prices/028260.KS";
    ...
    {
        int minY = 130000; // 최소 종가
        int maxY = 100000; // 최대 종가
