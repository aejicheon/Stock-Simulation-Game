...
using YourNamespace6;

public class posco_holding : MonoBehaviour
{
    private string url = "https://racconworld.com:8081/historical-stock-prices/005490.KS";
    ...
    {
        int minY = 670000; // 최소 종가
        int maxY = 260000; // 최대 종가
