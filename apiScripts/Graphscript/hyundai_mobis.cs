...
using YourNamespace14;

public class hyundai_mobis : MonoBehaviour
{
    private string url = "https://racconworld.com:8081/historical-stock-prices/012330.KS";
    ...
    {
        int minY = 260000; // 최소 종가
        int maxY = 190000; // 최대 종가
