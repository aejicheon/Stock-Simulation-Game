...
using YourNamespace17;

public class kakao : MonoBehaviour
{
    private string url = "https://racconworld.com:8081/historical-stock-prices/035720.KS";
    ...
    {
        int minY = 35000; // 최소 종가
        int maxY = 70000; // 최대 종가
