...
using YourNamespace4;

public class sk_hynix : MonoBehaviour
{
    private string url = "https://racconworld.com:8081/historical-stock-prices/000660.KS";
    ...
    {
        int minY = 150000; // 최소 종가
        int maxY = 74000; // 최대 종가

        float yMin = -180f; // 최소 y 위치
        float yMax = 160f; // 최대 y 위치
