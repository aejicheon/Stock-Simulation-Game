...
using YourNamespace13;

public class kb_finance : MonoBehaviour
{
    private string url = "https://racconworld.com:8081/historical-stock-prices/105560.KS";
    ...
    {
        int minY = 60000; // 최소 종가
        int maxY = 44000; // 최대 종가
