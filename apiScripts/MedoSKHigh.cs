...
public class MedoSKHigh : MonoBehaviour
{
    ...
    void TaskOnClick()
    {
        ...
        if (selector != null)
        {
            ...
            if (gameManager != null)
            {
                ...
                {
                    string SKHighVariable = "SKHigh";
                    gameManagerScript.MedoSKHighPNL(SKHighVariable, indicatorText, indicator1Text, gameManagerScript.skhweekValue);
                }
                else
                {
