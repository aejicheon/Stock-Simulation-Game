...
public class MedoLGEnergy : MonoBehaviour
{
    ...
    void TaskOnClick()
    {
        ...
        if (selector != null)
        {
            ...
            if (gameManager != null)
            {
                ...
                {
                    string LGEVariable = "LGEnergy";
                    gameManagerScript.MedoLGEPNL(LGEVariable, indicatorText, indicator1Text, gameManagerScript.lgeweekValue);
                }
                else
                {
