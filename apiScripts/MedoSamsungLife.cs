...
public class MedoSamsungLife : MonoBehaviour
{
    ...
    void TaskOnClick()
    {
        ...
        if (selector != null)
        {
            ...
            if (gameManager != null)
            {
                ...
                {
                    string SamLVariable = "Samsunglife";
                    gameManagerScript.MedoSamLPNL(SamLVariable, indicatorText, indicator1Text, gameManagerScript.SamLweekValue);
                }
                else
                {
