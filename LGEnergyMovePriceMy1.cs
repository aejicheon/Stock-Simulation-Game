...
public class LGEnergyMovePriceMy1 : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        yourButton.onClick.AddListener(() =>
        {
            ...
            InvokeRepeating("UpdateLGEnergyPNL", 0, 5); //****
        });
        gameManager = GameObject.Find("GameManager");
    }
    void UpdateLGEnergyPNL()
    {
        if (selector != null && gameManager != null)
        {
            ...
            {
                gameManagerScript.LGEnergyPNL(indicatorText); //****
    ...
    void TaskOnClickPriceMove()
    {
        if (selector != null)
        {
            ...
            if (gameManager != null)
            {
                ...
                if (gameManagerScript != null)
                {
                    gameManagerScript.LGEPNL(indicator1Text, indicatorText);//****
                }
                else
                {
                    Debug.LogError("GameManager 스크립트를 찾을 수 없습니다.");
