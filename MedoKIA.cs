...
public class MedoKIA : MonoBehaviour
{
    ...
    void TaskOnClick()
    {
        ...
        if (selector != null)
        {
            ...
            if (gameManager != null)
            {
                ...
                {
                    string KIAVariable = "KIA";
                    gameManagerScript.MedoKIAPNL(KIAVariable, indicatorText, indicator1Text, gameManagerScript.KIAweekValue);
                }
                else
                {
