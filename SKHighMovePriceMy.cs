...
public class SKHighMovePriceMy : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        yourButton.onClick.AddListener(() =>
        {
            ...
            InvokeRepeating("UpdateSKHighPNL", 0, 5);
        });
        gameManager = GameObject.Find("GameManager");
    }
    void UpdateSKHighPNL()
    {
        if (selector != null && gameManager != null)
        {
            ...
            {
                gameManagerScript.SKHighPNL(indicatorText); //****
    ...
    void TaskOnClickPriceMove()
    {
        if (selector != null)
        {
            ...
            if (gameManager != null)
            {
                ...
                if (gameManagerScript != null)
                {
                    gameManagerScript.SKHPNL(indicator1Text, indicatorText);//****
                }
                else
                {
                    Debug.LogError("GameManager 스크립트를 찾을 수 없습니다.");
