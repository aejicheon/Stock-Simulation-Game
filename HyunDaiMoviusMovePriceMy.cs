...
public class HyunDaiMoviusMovePriceMy : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        yourButton.onClick.AddListener(() =>
        {
            ...
            InvokeRepeating("UpdateHyunDMPNL", 0, 5);
        });
        gameManager = GameObject.Find("GameManager");
    }
    void UpdateHyunDMPNL()
    {
        if (selector != null && gameManager != null)
        {
            ...
            {
                gameManagerScript.HDMPNL(indicatorText); //****
    ...
    void TaskOnClickPriceMove()
    {
        if (selector != null)
        {
            ...
            if (gameManager != null)
            {
                ...
                if (gameManagerScript != null)
                {
                    gameManagerScript.HyunDMPNL(indicator1Text, indicatorText);//****
                }
                else
                {
                    Debug.LogError("GameManager 스크립트를 찾을 수 없습니다.");
