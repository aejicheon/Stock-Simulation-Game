...
public class MedoSamsung : MonoBehaviour
{
    ...
    void TaskOnClick()
    {
        ...
        if (selector != null)
        {
            ...
            if (gameManager != null)
            {
                ...
                {
                    string samsungVariable = "Samsung";
                    gameManagerScript.MedoSamPNL(samsungVariable, indicatorText,indicator1Text, gameManagerScript.weekValue);
                }
                else
                {
