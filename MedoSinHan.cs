...
public class MedoSinHan : MonoBehaviour
{
    ...
    void TaskOnClick()
    {
        ...
        if (selector != null)
        {
            ...
            if (gameManager != null)
            {
                ...
                {
                    string SinhanVariable = "Sinhan";
                    gameManagerScript.MedoSinHanPNL(SinhanVariable, indicatorText, indicator1Text, gameManagerScript.SinHanweekValue);
                }
                else
                {
