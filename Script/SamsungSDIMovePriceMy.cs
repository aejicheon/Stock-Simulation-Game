...
public class SamsungSDIMovePriceMy : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        yourButton.onClick.AddListener(() =>
        {
            ...
            InvokeRepeating("UpdateSamsungSDIPNL", 0, 5);
        });
        gameManager = GameObject.Find("GameManager");
    }
    void UpdateSamsungSDIPNL()
    {
        if (selector != null && gameManager != null)
        {
            ...
            {
                gameManagerScript.SamsungSDIPNL(indicatorText); //****
    ...
    void TaskOnClickPriceMove()
    {
        if (selector != null)
        {
            ...
            if (gameManager != null)
            {
                ...
                if (gameManagerScript != null)
                {
                    gameManagerScript.SSDIPNL(indicator1Text, indicatorText);//****
                }
                else
                {
                    Debug.LogError("GameManager 스크립트를 찾을 수 없습니다.");
