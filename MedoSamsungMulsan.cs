...
public class MedoSamsungMulsan : MonoBehaviour
{
    ...
    void TaskOnClick()
    {
        ...
        if (selector != null)
        {
            ...
            if (gameManager != null)
            {
                ...
                {
                    string samsungmulsanVariable = "SamsungMulsan";
                    gameManagerScript.MedoSamMPNL(samsungmulsanVariable, indicatorText, indicator1Text, gameManagerScript.SamMweekValue);
                }
                else
                {
