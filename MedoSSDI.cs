...
public class MedoSSDI : MonoBehaviour
{
    ...
    void TaskOnClick()
    {
        ...
        if (selector != null)
        {
            ...
            if (gameManager != null)
            {
                ...
                {
                    string SSDIVariable = "SamsungSDI";
                    gameManagerScript.MedoSSDIPNL(SSDIVariable, indicatorText, indicator1Text, gameManagerScript.SSDIweekValue);
                }
                else
                {
