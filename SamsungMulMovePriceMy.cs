...
public class SamsungMulMovePriceMy : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        yourButton.onClick.AddListener(() =>
        {
            ...
            InvokeRepeating("UpdateSamsungMulPNL", 0, 5);
        });
        gameManager = GameObject.Find("GameManager");
    }
    void UpdateSamsungMulPNL()
    {
        if (selector != null && gameManager != null)
        {
            ...
            {
                gameManagerScript.SMPNL(indicatorText); //****
    ...
    void TaskOnClickPriceMove()
    {
        if (selector != null)
        {
            ...
            if (gameManager != null)
            {
                ...
                if (gameManagerScript != null)
                {
                    gameManagerScript.SamMPNL(indicator1Text, indicatorText);//****
                }
                else
                {
                    Debug.LogError("GameManager 스크립트를 찾을 수 없습니다.");
