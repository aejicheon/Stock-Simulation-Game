...
public class KIAMovePriceMy : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        yourButton.onClick.AddListener(() =>
        {
            ...
            InvokeRepeating("UpdateKIAPNL", 0, 5);
        });
    ...
    void UpdateKIAPNL()
    {
        if (selector != null && gameManager != null)
        {
            ...
            {
                gameManagerScript.KIAAPNL(indicatorText); //****
    ...
    void TaskOnClickPriceMove()
    {
        if (selector != null)
        {
            ...
            if (gameManager != null)
            {
                ...
                if (gameManagerScript != null)
                {
                    gameManagerScript.KIAPNL(indicator1Text, indicatorText);//****
                }
                else
                {
                    Debug.LogError("GameManager 스크립트를 찾을 수 없습니다.");
