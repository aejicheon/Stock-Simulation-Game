...
public class MedoSamBio : MonoBehaviour
{
    ...
    void TaskOnClick()
    {
        ...
        if (selector != null)
        {
            ...
            if (gameManager != null)
            {
                ...
                {
                    string SamBioVariable = "SamsungBio";
                    gameManagerScript.MedoSamBioPNL(SamBioVariable, indicatorText, indicator1Text, gameManagerScript.SamBioweekValue);
                }
                else
                {
