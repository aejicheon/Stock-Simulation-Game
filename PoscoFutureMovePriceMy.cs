...
public class PoscoFutureMovePriceMy : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        yourButton.onClick.AddListener(() =>
        {
            ...
            InvokeRepeating("UpdatePoscoFuturePNL", 0, 5);
        });
        gameManager = GameObject.Find("GameManager");
    }
    void UpdatePoscoFuturePNL()
    {
        if (selector != null && gameManager != null)
        {
            ...
            {
                gameManagerScript.PoscoFPNL(indicatorText); //****
    ...
    void TaskOnClickPriceMove()
    {
        if (selector != null)
        {
            ...
            if (gameManager != null)
            {
                ...
                if (gameManagerScript != null)
                {
                    gameManagerScript.PFPNL(indicator1Text, indicatorText);//****
                }
                else
                {
                    Debug.LogError("GameManager 스크립트를 찾을 수 없습니다.");
