...
public class MedoLS : MonoBehaviour
{
    ...
    void TaskOnClick()
    {
        ...
        if (selector != null)
        {
            ...
            if (gameManager != null)
            {
                ...
                {
                    string LSVariable = "LS";
                    gameManagerScript.MedoLSPNL(LSVariable, indicatorText, indicator1Text, gameManagerScript.LSweekValue);
                }
                else
                {
