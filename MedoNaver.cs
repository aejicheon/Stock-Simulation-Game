...
public class MedoNaver : MonoBehaviour
{
    ...
    void TaskOnClick()
    {
        ...
        if (selector != null)
        {
            ...
            if (gameManager != null)
            {
                ...
                {
                    string NaverVariable = "Naver";
                    gameManagerScript.MedoNVPNL(NaverVariable, indicatorText, indicator1Text, gameManagerScript.NVweekValue);
                }
                else
                {
