...
public class MedoKakao : MonoBehaviour
{
    ...
    void TaskOnClick()
    {
        ...
        if (selector != null)
        {
            ...
            if (gameManager != null)
            {
                ...
                {
                    string KKOVariable = "Kakao";
                    gameManagerScript.MedoKKOPNL(KKOVariable, indicatorText, indicator1Text, gameManagerScript.KKOweekValue);
                }
                else
                {
