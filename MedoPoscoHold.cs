...
public class MedoPoscoHold : MonoBehaviour
{
    ...
    void TaskOnClick()
    {
        ...
        if (selector != null)
        {
            ...
            if (gameManager != null)
            {
                ...
                {
                    string PoscoHVariable = "PoscoHoldings";
                    gameManagerScript.MedoPoscoHPNL(PoscoHVariable, indicatorText, indicator1Text, gameManagerScript.PoscHweekValue);
                }
                else
                {
