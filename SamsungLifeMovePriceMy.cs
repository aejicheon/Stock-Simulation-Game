...
public class SamsungLifeMovePriceMy : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        yourButton.onClick.AddListener(() =>
        {
            ...
            InvokeRepeating("UpdateSamLifePNL", 0, 5);
        });
        gameManager = GameObject.Find("GameManager");
    }
    void UpdateSamLifePNL()
    {
        if (selector != null && gameManager != null)
        {
            ...
            {
                gameManagerScript.SamLPNL(indicatorText); //****
    ...
    void TaskOnClickPriceMove()
    {
        if (selector != null)
        {
            ...
            if (gameManager != null)
            {
                ...
                if (gameManagerScript != null)
                {
                    gameManagerScript.SamLifePNL(indicator1Text, indicatorText);//****
                }
                else
                {
                    Debug.LogError("GameManager 스크립트를 찾을 수 없습니다.");
