...
public class MedoEcoPro : MonoBehaviour
{
    ...
    void TaskOnClick()
    {
        ...
        if (selector != null)
        {
            ...
            if (gameManager != null)
            {
                ...
                {
                    string samsungVariable = "EcoPro";
                    gameManagerScript.MedoEcoProPNL(samsungVariable, indicatorText,indicator1Text, gameManagerScript.ecoweekValue);
                }
                else
                {
