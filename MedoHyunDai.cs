...
public class MedoHyunDai : MonoBehaviour
{
    ...
    void TaskOnClick()
    {
        ...
        if (selector != null)
        {
            ...
            if (gameManager != null)
            {
                ...
                {
                    string HyunDaiVariable = "HyunDai";
                    gameManagerScript.MedoHyunDPNL(HyunDaiVariable, indicatorText, indicator1Text, gameManagerScript.HyunDweekValue);
                }
                else
                {
